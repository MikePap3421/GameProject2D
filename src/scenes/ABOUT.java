...
public class ABOUT extends gamescene implements scenemethods{
    ...
    public void render(Graphics g) {
        ...
        g.drawString("for them to shoot and kill the Enemies! The author of this  ",190,520);
        g.drawString("program is Papageorgiou Mixail who was born on July 3th, 2004, ",190,560);
        ...
        g.drawString("for the Sprites. The soundtracks were taken from Pixabay.com,",190,680);
        g.drawString("Chosic.com. ",190,720);
